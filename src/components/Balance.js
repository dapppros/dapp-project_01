...
const Balance = () => {
  ...
  return (
    <div className='component exchange__transfers'>
      ...
      {/* Deposit/Withdraw Component 1 (ASH) */}

      <div className='exchange__transfers--form'>
        <div className='flex-between'>
          <p><small>Token</small><br /><img src={ASH} alt="Token Logo" />{symbols && symbols[0]}</p>
      ...
      {/* Deposit/Withdraw Component 2 (ISA) */}

      <div className='exchange__transfers--form'>
        <div className='flex-between'>
          <p><small>Token</small><br /><img src={ISA} alt="Token Logo" />{symbols && symbols[1]}</p>
