...
describe('Exchange', () => {
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy('Ashlandia', 'ASH', '1000000')
    token2 = await Token.deploy('ISA Token', 'ISA', '1000000')
    ...
    describe('Filling orders', async () => {
      ...
      describe('Success', () => {
        ...
        it('executes the trade and charge fees', async () => {
          ...
          expect(await exchange.balanceOf(token1.address, houseAccount.address)).to.equal(tokens(0))
          // Token get
          ...
          expect(await exchange.balanceOf(token2.address, houseAccount.address)).to.equal(tokens(0.01))
        })
